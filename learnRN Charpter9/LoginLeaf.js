...
import {StyleSheet,Text,View,Dimensions,TextInput,Alert, ActivityIndicator,ProgressViewIOS,Switch,SwitchIOS} from 'react-native';
...
export default class LearnRN extends Component{
    ...
    updateProgress(){
        let progress=(this.state.progress + 0.0025) % 1;
    ...
    render(){
        ...
        <View style={styles.container}>
            ...
            <ActivityIndicator  animating={this.state.aSwitch} color={'grey'} size={'large'}/>
            <ActivityIndicator  animating={!this.state.aSwitch} color={'grey'} size={'small'}/>
            <ProgressViewIOS progress={this.state.progress }/>
            <Switch onValueChange={this.onSwitchChanged} value={this.state.aSwitch} style={{marginTop:20}}/>
            <Switch onValueChange={this.onSwitchChanged} value={!this.state.aSwitch} style={{marginTop:20}}/>
